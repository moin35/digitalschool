                    ...
                    <li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                @if($e=\App\Attendence::where('institute_code','=',Auth::user()->institute_id)->where('created_at','LIKE',"%$p%")->where('type','=','Teacher')->where('status','=',2)->where('status','==',1)->count()==0)
                                <li><a href="{{URL::to('/')}}/give/absence/teacher/{{Auth::user()->institute_id}}">Teacher Attendance</a></li>
                                @elseif($e=\App\Attendence::where('institute_code','=',Auth::user()->institute_id)->where('created_at','LIKE',"%$p%")->where('type','=','Teacher')->where('status','==',1)->count()==0)
                                <li><a href="{{URL::to('teacher/attendence')}}">Teacher Attendance <?php echo "string";?></a></li>
                                <?php echo $e;?>
                                 @else

                                <li><a href="{{URL::to('teacher/attendence')}}">Teacher Attendance <?php echo "a";?></a></li>
                                @endif
